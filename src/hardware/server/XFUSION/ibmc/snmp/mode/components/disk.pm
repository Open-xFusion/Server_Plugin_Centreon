package hardware::server::XFUSION::ibmc::snmp::mode::components::disk;
...
sub check {
    ...
    my $diskStatusOid = ".1.3.6.1.4.1.58132.2.235.1.1.18.1.0";
    my $presentTableOid = ".1.3.6.1.4.1.58132.2.235.1.1.18.50.1.2";
    my $statusTableOid = ".1.3.6.1.4.1.58132.2.235.1.1.18.50.1.3";
    my $deviceTableOid = ".1.3.6.1.4.1.58132.2.235.1.1.18.50.1.6";
