package hardware::server::XFUSION::ibmc::snmp::mode::components::raid;
...
sub check {
    ...
    my $raidStatusOid = ".1.3.6.1.4.1.58132.2.235.1.1.36.50.1.7";
    my $bbuPresentOid = ".1.3.6.1.4.1.58132.2.235.1.1.36.50.1.16";
    my $bbuStatusOid = ".1.3.6.1.4.1.58132.2.235.1.1.36.50.1.18";
