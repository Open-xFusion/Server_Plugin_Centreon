package hardware::server::XFUSION::ibmc::snmp::mode::components::system;
...
sub check {
    ...
    my $systemStatusOid = ".1.3.6.1.4.1.58132.2.235.1.1.1.1.0";
    my $deviceNameOid = ".1.3.6.1.4.1.58132.2.235.1.1.1.6.0";
    my $deviceSerialNo = ".1.3.6.1.4.1.58132.2.235.1.1.1.7.0";
    my $systemPowerState = ".1.3.6.1.4.1.58132.2.235.1.1.1.12.0";
